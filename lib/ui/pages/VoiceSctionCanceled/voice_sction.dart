...
TextEditingController audioFileCanceled = TextEditingController();

class VoiceSctionCanceled extends StatefulWidget {
  const VoiceSctionCanceled({
    super.key,
  });

  @override
  State<VoiceSctionCanceled> createState() => _VoiceSctionCanceledState();
}

class _VoiceSctionCanceledState extends State<VoiceSctionCanceled> {
        ...
        Row(
          ...
          children: [
            GestureDetector(
              ...
              onTap: audioFileCanceled.text.isNotEmpty
                  ? () {
                      snackBar(context,
            ...
            15.wBox,
            audioFileCanceled.text.isEmpty
                ? 0.hBox
                : Row(
                    children: [
                      SizedBox(
                        height: 60,
                        width: 200,
                        child: AudioBubble(filepath: audioFileCanceled.text),
                      ),
                      10.wBox,
                      GestureDetector(
                          onTap: () {
