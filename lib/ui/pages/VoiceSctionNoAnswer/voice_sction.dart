...
TextEditingController audioFileNoAnswer = TextEditingController();

class VoiceSctionNoAnswer extends StatefulWidget {
  const VoiceSctionNoAnswer({
    super.key,
  });

  @override
  State<VoiceSctionNoAnswer> createState() => _VoiceSctionNoAnswerState();
}

class _VoiceSctionNoAnswerState extends State<VoiceSctionNoAnswer> {
        ...
        Row(
          ...
          children: [
            GestureDetector(
              ...
              onTap: audioFileNoAnswer.text.isNotEmpty
                  ? () {
                      snackBar(context,
            ...
            15.wBox,
            audioFileNoAnswer.text.isEmpty
                ? 0.hBox
                : Row(
                    children: [
                      SizedBox(
                        height: 60,
                        width: 200,
                        child: AudioBubble(filepath: audioFileNoAnswer.text),
                      ),
                      10.wBox,
                      GestureDetector(
                          onTap: () {
